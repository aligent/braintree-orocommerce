...
class LoadWarehouseAndInventoryLevels extends AbstractFixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->createWarehouseInventoryLevel($manager, self::WAREHOUSE2, 'product_unit_precision.product-1.liter', 10);
        $this->createWarehouseInventoryLevel($manager, self::WAREHOUSE2, 'product_unit_precision.product-1.bottle', 99);
        $this->createWarehouseInventoryLevel(
            $manager,
            self::WAREHOUSE2,
            'product_unit_precision.product-1.milliliter',
            299
        );
        $this->createWarehouseInventoryLevel(
            $manager,
