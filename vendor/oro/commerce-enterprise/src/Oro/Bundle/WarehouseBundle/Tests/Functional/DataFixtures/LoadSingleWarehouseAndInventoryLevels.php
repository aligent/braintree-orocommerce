...
use Oro\Bundle\WarehouseBundle\Tests\Functional\DataFixtures\LoadWarehouseAndInventoryLevels as BaseFixture;

class LoadSingleWarehouseAndInventoryLevels extends BaseFixture
{
    /**
     * {@inheritdoc}
     */
