...
use Oro\Bundle\WarehouseBundle\Tests\Functional\DataFixtures\LoadWarehouseInventoryLevelWithPrimaryUnit;
...
class WarehouseInventoryLevelApiTest extends RestJsonApiTestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->loadFixtures([LoadWarehouseInventoryLevelWithPrimaryUnit::class]);
    }
                            ...
                            'warehouse' => [
                                ...
                                'references' => [
                                    'warehouse' => [
                                        'key' => 'id',
                                        'method' => 'getId',
                                        'reference' => LoadWarehouseAndInventoryLevels::WAREHOUSE1,
                                    ],
                                ],
                            ],
                        ],
                            ...
                            'warehouse' => [
                                ...
                                'references' => [
                                    'warehouse' => [
                                        'key' => 'id',
                                        'method' => 'getId',
                                        'reference' => LoadWarehouseAndInventoryLevels::WAREHOUSE2,
                                    ],
                                ],
                            ],
                        ],
            ...
            'filter by Products and Warehouse' => [
                'filter' => [
                    ...
                    [
                        'method' => 'getId',
                        'key' => 'warehouse.id',
                        'references' => [LoadWarehouseAndInventoryLevels::WAREHOUSE2]
                    ],
                ],
                'expectedCount' => 4,
                'expectedContent' => [
            ...
            'filter by Products, Warehouse and Unit' => [
                'filter' => [
                    ...
                    [
                        'method' => 'getId',
                        'key' => 'warehouse.id',
                        'references' => [LoadWarehouseAndInventoryLevels::WAREHOUSE1]
                    ],
                    [
                        'method' => 'getCode',
                        'key' => 'productUnitPrecision.unit.code',
            ...
            'filter by Products, Warehouses and Units' => [
                'filter' => [
                    ...
                    [
                        ...
                        'key' => 'warehouse',
                        'references' => [
                            LoadWarehouseAndInventoryLevels::WAREHOUSE1,
                            LoadWarehouseAndInventoryLevels::WAREHOUSE2
                        ]
                    ],
                    [
                        'method' => 'getCode',
    ...
    {
        /** @var Warehouse $warehouse */
        $warehouse = $this->getReference(LoadWarehouseAndInventoryLevels::WAREHOUSE2);
        $entityType = $this->getEntityType(InventoryLevel::class);
        ...
        $this->assertCreatedInventoryLevel($warehouse, 'product-3', 'liter', 100);
    }
    ...
    {
        $this->markTestSkipped('skipped due to issue BAP-12369');
        /** @var EntityManagerInterface $em */
        $em = $this->getReferenceRepository()->getManager();
        $em->remove($this->getReference(LoadWarehouseAndInventoryLevels::WAREHOUSE2));
        $em->flush();
