...
namespace Oro\Bundle\WarehouseBundle\Tests\Unit\ImportExport\Reader;
...
class ProInventoryLevelReaderTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @param string $name
     * @param bool $full
     * @return InventoryLevelWithWarehouseReader
     */
    protected function getReader($name = '', $full = false)
    {
        ...
        return new InventoryLevelWithWarehouseReader($contextRegistry, $managerRegistry, $ownershipMetadataProvider);
    }
