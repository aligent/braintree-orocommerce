...
namespace Oro\Bundle\PricingProBundle\Tests\Functional\Controller\Frontend;

use Doctrine\Common\Util\ClassUtils;
use Oro\Bundle\CustomerBundle\Entity\CustomerUser;
use Oro\Bundle\CustomerBundle\Entity\CustomerUserSettings;
use Oro\Bundle\FrontendTestFrameworkBundle\Migrations\Data\ORM\LoadCustomerUserData;
use Oro\Bundle\PricingProBundle\DependencyInjection\Configuration as PricingProConfig;
...
class AjaxEntityTotalsControllerTest extends WebTestCase
{
    ...
    public function testEntityTotalsActionForShoppingList()
    {
        ...
        $manager->set(PricingProConfig::getConfigKeyByName(PricingProConfig::DEFAULT_CURRENCY), 'EUR');
        $manager->set(PricingProConfig::getConfigKeyByName(PricingProConfig::ENABLED_CURRENCIES), ['EUR']);
        $manager->flush();
