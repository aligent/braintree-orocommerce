...
class PriceListFormViewListener
{
    ...
    public function onPriceListView(BeforeListRenderEvent $event)
    {
        ...
        $priceList = $this->doctrineHelper->getEntityReference('OroPricingBundle:PriceList', $priceListId);

        $template = $event->getEnvironment()->render(
            'OroMultiWebsiteBundle:PriceList/partial:website_section.html.twig',
            [
                'entity' => $priceList
            ]
        );
    ...
    {
        $blockLabel = $this->translator->trans('oro.website.entity_plural_label');
