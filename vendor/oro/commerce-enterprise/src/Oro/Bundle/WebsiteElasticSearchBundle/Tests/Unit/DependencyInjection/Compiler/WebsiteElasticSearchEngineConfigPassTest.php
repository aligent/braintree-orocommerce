...
use Oro\Bundle\ElasticSearchBundle\Tests\Unit\DependencyInjection\Compiler\AbstractElasticSearchProviderPassTest;
use Oro\Bundle\WebsiteElasticSearchBundle\DependencyInjection\Compiler\WebsiteElasticSearchEngineConfigPass;

class WebsiteElasticSearchEngineConfigPassTest extends AbstractElasticSearchProviderPassTest
{
    public function setUp()
    {
        parent::setUp();

        $this->compiler = new WebsiteElasticSearchEngineConfigPass();
    }
    ...
    public function incorrectIndexParameterProvider()
    {
        return [
            'not an array' => [
                ...
                'message' => 'ES engine parameter (oro_website_search.engine_parameters.index) should be an array'
            ],
            'index parameter is not in array' => [
                'parameters' => [
                    'index' => ['body' => []],
                ],
                'message' => 'ES engine parameter (oro_website_search.engine_parameters.index.index) is required'
            ],
        ];
    }
        ...
        return [
            ...
            'empty global configuration. Parameters used' => [
                ...
                'getParameters' => [
                    'search_engine_name' => ElasticSearch::ENGINE_NAME,
                    'oro_website_search.engine_parameters' => [],
                    'website_search_engine_index_name' => self::DEFAULT_INDEX_NAME,
