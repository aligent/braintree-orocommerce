...
namespace Oro\Bundle\OutlookBundle\Controller\Api\Rest;
...
class ConfigurationController extends FOSRestController
{
    ...
    public function getAction($path)
    {
        ...
        $manager = $this->get('oro_outlook.config_manager.api');
    ...
    {
        if ($this->getSecurityFacade()->isGranted('oro_outlook_integration')
