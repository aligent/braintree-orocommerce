...
namespace Oro\Bundle\OutlookBundle\Tests\Unit\Api\Processor\GetList;
...
use Oro\Bundle\OutlookBundle\Api\Processor\GetList\LoadConfigurationSections;
...
class LoadConfigurationSectionsTest extends GetListProcessorTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->outlookConfigRepository = $this
            ->getMockBuilder('Oro\Bundle\OutlookBundle\Api\Repository\OutlookConfigurationRepository')
