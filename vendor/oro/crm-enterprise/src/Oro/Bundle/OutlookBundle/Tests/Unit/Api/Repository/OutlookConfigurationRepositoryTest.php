...
namespace Oro\Bundle\OutlookBundle\Tests\Unit\Api\Repository;

use Oro\Bundle\ConfigBundle\Api\Model\ConfigurationOption;
use Oro\Bundle\CRMBundle\OroCRMBundle;
use Oro\Bundle\OutlookBundle\Api\Repository\OutlookConfigurationRepository;
...
class OutlookConfigurationRepositoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        $this->versionHelper = $this->getMockBuilder('Oro\Bundle\PlatformBundle\Composer\VersionHelper')
            ...
            ->getMock();
        $this->addInManager = $this->getMockBuilder('Oro\Bundle\OutlookBundle\Manager\AddInManager')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testOutlookSectionWhenNoAddIn()
    {
        ...
        $this->assertConfigOptionsEqual(
            [
                [
                    'key'   => 'oro_outlook.orocrm_version',
                    'type'  => 'string',
                    'value' => '1.2'
                ],
                [
                    'key'   => 'oro_outlook.addin_latest_version',
                    'type'  => 'string',
                    'value' => null
                ],
            ],
    ...
    public function testOutlookSectionWhenNoDocFileAndMinSupportedVersion()
    {
        ...
        $this->assertConfigOptionsEqual(
            [
                ...
                [
                    'key'   => 'oro_outlook.addin_latest_version_url',
                    'type'  => 'string',
    ...
    public function testOutlookSectionWithDocFileAndMinSupportedVersion()
    {
        ...
        $this->assertConfigOptionsEqual(
            [
                ...
                [
                    'key'   => 'oro_outlook.addin_latest_version_doc_url',
                    'type'  => 'string',
                    'value' => 'http://host/AddIn_2.3.4.md'
                ],
                [
                    'key'   => 'oro_outlook.addin_min_supported_version',
                    'type'  => 'string',
                    'value' => '2.0'
                ],
            ],
