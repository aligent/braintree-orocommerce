...
class AmqpTransportFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testThrowIfHostOptionNotConfigured()
    {
        ...
        $this->expectExceptionMessage('The child node "host" at path "foo" must be configured.');
    ...
    public function testThrowIfPortOptionNotConfigured()
    {
        ...
        $this->expectException(InvalidConfigurationException::class);
        $this->expectExceptionMessage('The child node "port" at path "foo" must be configured.');
    ...
    public function testThrowIfUserOptionNotConfigured()
    {
        ...
        $this->expectException(InvalidConfigurationException::class);
        $this->expectExceptionMessage('The child node "user" at path "foo" must be configured.');
    ...
    public function testThrowIfPasswordOptionNotConfigured()
    {
        ...
        $this->expectException(InvalidConfigurationException::class);
        $this->expectExceptionMessage('The child node "password" at path "foo" must be configured.');
    ...
    public function testThrowIfVHostOptionNotConfigured()
    {
        ...
        $this->expectException(InvalidConfigurationException::class);
        $this->expectExceptionMessage('The child node "vhost" at path "foo" must be configured.');
