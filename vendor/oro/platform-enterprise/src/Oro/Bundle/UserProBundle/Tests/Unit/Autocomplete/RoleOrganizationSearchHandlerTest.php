...
namespace Oro\Bundle\UserProBundle\Tests\Unit\Autocomplete;
...
use Oro\Bundle\UserProBundle\Autocomplete\RoleOrganizationSearchHandler;
...
class RoleOrganizationSearchHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->organization = $this->createPartialMock(
            'Oro\Bundle\OrganizationBundle\Entity\Organization',
            ['getIsGlobal', 'getId']
        );

        $this->organizationHelper = $this
            ->getMockBuilder('Oro\Bundle\OrganizationProBundle\Helper\OrganizationProHelper')
            ->disableOriginalConstructor()
            ->getMock();
