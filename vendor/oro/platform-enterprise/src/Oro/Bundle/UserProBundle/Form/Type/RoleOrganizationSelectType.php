...
namespace Oro\Bundle\UserProBundle\Form\Type;
...
class RoleOrganizationSelectType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $defaults = [
            'configs' => [
                'placeholder' => 'oro.userpro.role.global_organization.label',

            ],
            'autocomplete_alias' => 'oro_userpro_role_organizations',
        ];
    ...
    {
        return 'oro_userpro_role_organization_select';
    }
}
