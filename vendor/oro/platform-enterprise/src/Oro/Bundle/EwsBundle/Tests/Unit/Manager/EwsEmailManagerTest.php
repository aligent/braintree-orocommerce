...
use Oro\Bundle\EwsBundle\Connector\EwsAdditionalPropertiesBuilder;
...
class EwsEmailManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $connector = $this->getMockBuilder('Oro\Bundle\EwsBundle\Connector\EwsConnector')
    ...
    public function testGetEmails(
        ...
        $query = $this->getMockBuilder('Oro\Bundle\EwsBundle\Connector\Search\SearchQuery')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testFindEmail($message)
    {
        ...
        $itemId = $this->getMockBuilder('Oro\Bundle\EwsBundle\Manager\DTO\ItemId')
