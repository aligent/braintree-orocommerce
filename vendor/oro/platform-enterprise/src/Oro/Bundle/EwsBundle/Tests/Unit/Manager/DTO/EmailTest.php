...
class EmailTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $manager = $this->getMockBuilder('Oro\Bundle\EwsBundle\Manager\EwsEmailManager')
        ...
        $body = $this->getMockBuilder('Oro\Bundle\EwsBundle\Manager\DTO\Email')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $attachment = $this->getMockBuilder('Oro\Bundle\EwsBundle\Manager\DTO\EmailAttachment')
            ->disableOriginalConstructor()
            ->getMock();
        $manager->expects($this->once())
