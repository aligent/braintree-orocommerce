...
use Oro\Bundle\EwsBundle\Provider\EwsEmailBodyLoader;
...
class EwsEmailBodyLoaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->connector = $this->getMockBuilder('Oro\Bundle\EwsBundle\Connector\EwsConnector')
    ...
    {
        $ewsEmailManager = $this->getMockBuilder('Oro\Bundle\EwsBundle\Manager\EwsEmailManager')
        ...
        $this->ewsEmailBodyLoader = $this->getMockBuilder('Oro\Bundle\EwsBundle\Provider\EwsEmailBodyLoader')
    ...
    protected function getDoctrineMocks()
    {
        ...
        $repo = $this->getMockBuilder('Doctrine\ORM\EntityRepository')
            ->setConstructorArgs([$this->em, new ClassMetadata('OroEwsBundle:EwsEmail')])
            ->getMock();
    ...
    {
        $email = new \Oro\Bundle\EwsBundle\Manager\DTO\Email($ewsEmailManager);
        $email
            ->setId(new \Oro\Bundle\EwsBundle\Manager\DTO\ItemId('aaa', 'bbb'))
            ->setSubject('test subject');

        $body = new \Oro\Bundle\EwsBundle\Manager\DTO\EmailBody();
        $body
