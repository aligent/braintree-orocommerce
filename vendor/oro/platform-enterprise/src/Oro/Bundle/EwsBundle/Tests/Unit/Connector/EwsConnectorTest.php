<?php
namespace Oro\Bundle\EwsBundle\Tests\Unit\Connector;

use Oro\Bundle\EwsBundle\Connector\EwsConnector;
use Oro\Bundle\EwsBundle\Connector\Search\SearchQueryBuilder;
...
class EwsConnectorTest extends \PHPUnit_Framework_TestCase
{
    public function testFindItemsEmptyResult()
    {
        ...
        $ewsMock = $this->getMockBuilder('Oro\Bundle\EwsBundle\Ews\ExchangeWebServices')
    ...
    public function testFindItemsWithQuery()
    {
        ...
        $configurator = $this->getMockBuilder('Oro\Bundle\EwsBundle\Provider\EwsServiceConfigurator')
            ->disableOriginalConstructor()
            ->getMock();
