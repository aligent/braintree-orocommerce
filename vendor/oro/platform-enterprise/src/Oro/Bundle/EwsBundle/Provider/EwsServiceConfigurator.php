...
namespace Oro\Bundle\EwsBundle\Provider;
...
class EwsServiceConfigurator
{
    ...
    {
        return $this->cm->get('oro_ews.server');
    }
    ...
    {
        return $this->cm->get('oro_ews.login');
    }
    ...
    {
        return $this->cm->get('oro_ews.version');
    }
    ...
    {
        return $this->cm->get('oro_ews.domain_list');
    }
    ...
    {
        return (bool)$this->cm->get('oro_ews.enabled');
    }
}
