...
namespace Oro\Bundle\EwsBundle\Entity;
 ...
 * )
 * @ORM\Entity(repositoryClass="Oro\Bundle\EwsBundle\Entity\Repository\EwsEmailRepository")
 */
class EwsEmail
{
    /**
     ...
     * @var EwsEmailFolder
     *
     * @ORM\ManyToOne(targetEntity="Oro\Bundle\EwsBundle\Entity\EwsEmailFolder")
