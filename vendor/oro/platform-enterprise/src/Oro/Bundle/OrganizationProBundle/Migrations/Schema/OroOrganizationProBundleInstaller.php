...
class OroOrganizationProBundleInstaller implements Installation
{
    /**
     * {@inheritdoc}
     */
        ...
        $table->addColumn(
            ...
            [
                OroOptions::KEY => [
                    ...
                    'form' => ['form_type' => 'oro_organizationpro_is_global'],
     ...
     * @param Schema $schema
     */
    public function createOroProOrganizationUserTable(Schema $schema)
    {
