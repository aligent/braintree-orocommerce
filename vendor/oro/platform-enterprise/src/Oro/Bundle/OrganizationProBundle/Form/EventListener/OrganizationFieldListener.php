...
namespace Oro\Bundle\OrganizationProBundle\Form\EventListener;
...
{
    const ORGANIZATION_FIELD_TEMPLATE = 'OroOrganizationProBundle::organizationSelector.html.twig';
