...
{
    const NAME = 'oro_organizationpro';
    ...
    {
        $result = $this->translator->trans('oro.organizationpro.datagrid.applicable_none');

        $data = is_array($value) ? $value : json_decode($value, true);
        if (!is_array($data)) {
            return $result;
        } elseif ($data['all'] === true) {
            return $this->translator->trans('oro.organizationpro.datagrid.applicable_all');
