...
use Oro\Bundle\OrganizationProBundle\Entity\Repository\UserPreferredOrganizationRepository;

class AuthenticationListener
{
    const MULTIORG_LOGIN_FIRST       = 'oro_organizationpro_mlf';
    const MULTIORG_LOGIN_UNPREFERRED = 'oro_organizationpro_mlu';
    ...
    {
        return $this->registry->getRepository('OroOrganizationProBundle:UserPreferredOrganization');
    }
