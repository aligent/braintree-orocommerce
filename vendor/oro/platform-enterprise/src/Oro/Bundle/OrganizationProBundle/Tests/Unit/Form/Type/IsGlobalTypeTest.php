...
use Oro\Bundle\OrganizationProBundle\Form\Type\IsGlobalType;
...
class IsGlobalTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->helper = $this->getMockBuilder('Oro\Bundle\OrganizationProBundle\Helper\OrganizationProHelper')
    ...
    {
        $this->assertEquals('oro_organizationpro_is_global', $this->type->getName());
    }
    ...
    public function testSetDefaultOptions($value, $globalOrgId, $entityyId, $isExpectsViolation)
    {
        ...
        $this->assertEquals('oro.organizationpro.form.is_global', $result['tooltip']);
