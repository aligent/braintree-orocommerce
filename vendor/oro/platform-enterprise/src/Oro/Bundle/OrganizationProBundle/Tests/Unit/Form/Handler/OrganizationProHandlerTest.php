...
namespace Oro\Bundle\OrganizationProBundle\Tests\Unit\Form\Handler;
...
use Oro\Bundle\OrganizationProBundle\Form\Handler\OrganizationProHandler;
...
class OrganizationProHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testProcessValidData()
    {
        ...
        $appendForm = $this->createMock('Symfony\Component\Form\Test\FormInterface');
        $removeForm = $this->createMock('Symfony\Component\Form\Test\FormInterface');
