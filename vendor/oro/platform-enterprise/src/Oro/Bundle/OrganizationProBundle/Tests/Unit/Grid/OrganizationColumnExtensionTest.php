...
namespace Oro\Bundle\OrganizationProBundle\Tests\Unit\Grid;

use Oro\Bundle\DataGridBundle\Datagrid\Common\DatagridConfiguration;

use Oro\Bundle\OrganizationProBundle\Grid\OrganizationColumnExtension;
...
class OrganizationColumnExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->organizationProvider =
            $this->getMockBuilder('Oro\Bundle\OrganizationProBundle\Provider\SystemAccessModeOrganizationProvider')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testIsApplicableFalseIfNotOrmType()
    {
        $this->securityFacade->expects($this->never())
            ->method('getOrganization');

        $this->assertFalse($this->extension->isApplicable($this->getDatagridConfiguration([], 'not_orm_source_type')));
    }
     ...
     */
    protected function getDatagridConfiguration($sorters, $type = OrmDatasource::TYPE)
    {
        $params = [
            'extended_entity_name' => 'Acme\Bundle\UserBundle\Entity\User',
            'options' => [],
