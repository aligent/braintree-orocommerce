...
namespace Oro\Bundle\OrganizationProBundle\Tests\Unit\Twig;

use Oro\Bundle\OrganizationProBundle\Twig\OrganizationExtension;
...
class OrganizationExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->organizationHelper =
            $this->getMockBuilder('Oro\Bundle\OrganizationProBundle\Helper\OrganizationProHelper')
                ->disableOriginalConstructor()
                ->getMock();
