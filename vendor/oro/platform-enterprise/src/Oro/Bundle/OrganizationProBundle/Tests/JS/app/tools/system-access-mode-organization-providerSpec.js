define([
    'oroorganizationpro/js/app/tools/system-access-mode-organization-provider'
    ...
    describe('oroorganizationpro/js/app/tools/system-access-mode-organization-provider', function() {
