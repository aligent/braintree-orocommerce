...
use Oro\Bundle\OrganizationProBundle\EventListener\ReportNavigationListener;
...
class ReportNavigationListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $organizationProvider = $this
            ->createMock('Oro\Bundle\OrganizationProBundle\Provider\SystemAccessModeOrganizationProvider');
