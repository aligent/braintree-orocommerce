...
use Oro\Bundle\OrganizationProBundle\EventListener\AuthenticationListener;
...
class AuthenticationListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testShouldSetPreferredOrganization()
    {
        ...
        $this->registry->expects($this->any())->method('getRepository')
            ->with('OroOrganizationProBundle:UserPreferredOrganization')->willReturn($repo);
    ...
    {
        return $this
            ->getMockBuilder('Oro\Bundle\OrganizationProBundle\Entity\Repository\UserPreferredOrganizationRepository')
            ->disableOriginalConstructor()->getMock();
    }
