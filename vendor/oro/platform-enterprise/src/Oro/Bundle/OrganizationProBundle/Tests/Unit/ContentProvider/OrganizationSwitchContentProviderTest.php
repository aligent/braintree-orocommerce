...
namespace Oro\Bundle\OrganizationProBundle\Tests\Unit\ContentProvider;

use Oro\Bundle\OrganizationProBundle\ContentProvider\OrganizationSwitchContentProvider;
