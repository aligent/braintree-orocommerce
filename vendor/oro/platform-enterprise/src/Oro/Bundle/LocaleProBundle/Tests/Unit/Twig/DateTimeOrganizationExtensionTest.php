...
namespace Oro\Bundle\LocaleProBundle\Tests\Unit\Twig;

use Oro\Bundle\LocaleProBundle\Twig\DateTimeOrganizationExtension;
...
class DateTimeOrganizationExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('oro_locale_pro_datetime_organization', $this->extension->getName());
    }
}
