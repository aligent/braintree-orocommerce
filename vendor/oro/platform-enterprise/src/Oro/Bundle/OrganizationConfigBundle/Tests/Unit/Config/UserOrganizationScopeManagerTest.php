...
namespace Oro\Bundle\OrganizationConfigBundle\Tests\Unit\Config;

use Oro\Bundle\UserBundle\Entity\User;
use Oro\Bundle\OrganizationBundle\Entity\Organization;
use Oro\Bundle\OrganizationConfigBundle\Config\UserOrganizationScopeManager;
...
class UserOrganizationScopeManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testInitializeScopeId()
    {
        ...
        $repo = $this->getMockBuilder('Oro\Bundle\OrganizationProBundle\Entity\Repository\UserOrganizationRepository')
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->doctrine->expects($this->once())
            ...
            ->with('OroOrganizationProBundle:UserOrganization')
            ->willReturn($em);
    ...
    public function testSetScopeIdFromEntity()
    {
        ...
        $userOrganization = $this->getMockBuilder('Oro\Bundle\OrganizationProBundle\Entity\UserOrganization')
            ->disableOriginalConstructor()
            ->getMock();
