...
namespace Oro\Bundle\SecurityProBundle\EventListener;
...
use Oro\Bundle\SecurityProBundle\Model\Action\AceQueryInterface;
    ...
    public function postFlushConfig(PostFlushConfigEvent $event)
    {
        ...
        foreach ($event->getModels() as $model) {
            ...
            if ($model instanceof EntityConfigModel) {
                ...
                $aclClass = $this->registry->getRepository('OroSecurityProBundle:AclClass')
