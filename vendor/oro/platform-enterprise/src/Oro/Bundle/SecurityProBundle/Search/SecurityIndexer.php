...
namespace Oro\Bundle\SecurityProBundle\Search;
...
use Oro\Bundle\SecurityProBundle\Formatter\ShareFormatter;
use Oro\Bundle\SecurityProBundle\Provider\ShareScopeProvider;
        ...
        foreach ($objects as $object) {
            ...
            $rows[] = [
                ...
                'entity' => $this->twig->render(
                    'OroSecurityProBundle:Share:Property/entity.html.twig',
                    [
                        'value' => $details,
                    ]
                ),
