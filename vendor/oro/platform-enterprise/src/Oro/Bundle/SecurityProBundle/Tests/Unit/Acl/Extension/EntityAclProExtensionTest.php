...
namespace Oro\Bundle\SecurityProBundle\Tests\Unit\Acl\Extension;
...
use Oro\Bundle\SecurityProBundle\Owner\Metadata\RootOwnershipProMetadata;
use Oro\Bundle\SecurityProBundle\Tests\Unit\Fixture\GlobalOrganization;
use Oro\Bundle\SecurityProBundle\Tests\Unit\TestHelper;
use Oro\Bundle\SecurityProBundle\Tests\Unit\Acl\Domain\Fixtures\OwnershipMetadataProProviderStub;
use Oro\Bundle\SecurityProBundle\Acl\Extension\EntityAclProExtension;
...
class EntityAclProExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetAccessLevelNamesForRoot()
    {
        ...
        $metaData = new RootOwnershipProMetadata();
        $this->metadataProvider->setMetadata(ObjectIdentityFactory::ROOT_IDENTITY_TYPE, $metaData);
        $this->assertEquals(
            [
                0 => 'NONE',
                1 => 'BASIC',
