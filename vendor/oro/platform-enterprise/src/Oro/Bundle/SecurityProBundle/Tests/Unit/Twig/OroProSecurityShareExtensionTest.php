...
namespace Oro\Bundle\SecurityProBundle\Tests\Twig;
...
use Oro\Bundle\SecurityProBundle\Twig\OroProSecurityShareExtension;
...
class OroProSecurityShareExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('oro_securitypro_share_extension', $this->twigExtension->getName());
    }
