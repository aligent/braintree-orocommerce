...
namespace Oro\Bundle\SecurityProBundle\Tests\Unit\Owner\Metadata;
...
class OwnershipProMetadataTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $reflection = new \ReflectionClass('Oro\Bundle\SecurityProBundle\Owner\Metadata\OwnershipProMetadata');
