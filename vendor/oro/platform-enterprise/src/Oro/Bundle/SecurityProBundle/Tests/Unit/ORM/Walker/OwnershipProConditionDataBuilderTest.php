...
namespace Oro\Bundle\SecurityProBundle\Tests\Unit\ORM\Walker;
...
use Oro\Bundle\SecurityProBundle\ORM\Walker\OwnershipProConditionDataBuilder;
use Oro\Bundle\SecurityProBundle\Owner\Metadata\OwnershipProMetadata;
use Oro\Bundle\SecurityProBundle\Tests\Unit\Acl\Domain\Fixtures\Entity\Organization;
use Oro\Bundle\SecurityProBundle\Tests\Unit\Acl\Domain\Fixtures\OwnershipMetadataProProviderStub;
...
class OwnershipProConditionDataBuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    const ORGANIZATION = 'Oro\Bundle\SecurityProBundle\Tests\Unit\Acl\Domain\Fixtures\Entity\Organization';
    ...
    protected function setUp()
    {
        ...
        $organizationProviderClass = 'Oro\Bundle\OrganizationProBundle\Provider\SystemAccessModeOrganizationProvider';
