...
namespace Oro\Bundle\SecurityProBundle\Tests\Unit\Acl\Dbal;
...
use Oro\Bundle\SecurityProBundle\Acl\Dbal\MutableAclProvider;
...
class MutableAclProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $platform = $platform = $this->getMockBuilder('Doctrine\DBAL\Platforms\AbstractPlatform')
