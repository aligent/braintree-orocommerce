...
namespace Oro\Bundle\SecurityProBundle\Tests\Unit\Provider;

use Oro\Bundle\SecurityProBundle\Provider\ShareGridProvider;
...
class ShareGridProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->shareScopeProvider = $this->getMockBuilder('Oro\Bundle\SecurityProBundle\Provider\ShareScopeProvider')
            ->disableOriginalConstructor()
            ->getMock();
