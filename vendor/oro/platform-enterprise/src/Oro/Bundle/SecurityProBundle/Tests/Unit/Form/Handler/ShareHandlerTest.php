...
namespace Oro\Bundle\SecurityProBundle\Tests\Unit\Form\Handler;
...
use Oro\Bundle\SecurityProBundle\Form\Handler\ShareHandler;
...
class ShareHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testProcessUnsupportedRequest()
    {
        ...
        $entityClassForm = $this->createMock('Symfony\Component\Form\FormInterface');
        $entityClassForm->expects($this->once())->method('setData')->with(get_class($this->entity));

        $entityIdForm = $this->createMock('Symfony\Component\Form\FormInterface');
    ...
    protected function assertAclProviderCalled(SecurityIdentityInterface $sid, $requiredMask)
    {
        ...
        $aceOld = $this->createMock('Symfony\Component\Security\Acl\Model\EntryInterface');
