...
namespace Oro\Bundle\SecurityProBundle\Tests\Unit\Licence;

use Oro\Bundle\SecurityProBundle\Licence\ServerAgent;
...
class ServerAgentTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->sender = $this->getMockBuilder('Oro\Bundle\SecurityProBundle\Licence\Sender')
