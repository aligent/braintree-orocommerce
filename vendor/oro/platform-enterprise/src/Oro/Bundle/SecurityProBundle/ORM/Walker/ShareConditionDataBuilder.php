...
namespace Oro\Bundle\SecurityProBundle\ORM\Walker;
...
{
    const ACL_ENTRIES_SCHEMA_NAME = 'Oro\Bundle\SecurityProBundle\Entity\AclEntry';
    ...
    public function getAclShareData($entityName, $entityAlias, $permissions = BasicPermissionMap::PERMISSION_VIEW)
    {
        ...
        $aclClass = $this->getObjectManager()->getRepository('OroSecurityProBundle:AclClass')
    ...
    protected function getSecurityIdentityId(SecurityIdentityInterface $sid)
    {
        ...
        return $this->getObjectManager()->getRepository('OroSecurityProBundle:AclSecurityIdentity')
            ->findOneBy([
