...
{
    const NEW_ACL_SECURITY_ID_STRATEGY_CLASS = 'oro_securitypro.acl.security_identity_retrieval_strategy.class';
    const DEFAULT_ACL_SECURITY_ID_STRATEGY_CLASS = 'security.acl.security_identity_retrieval_strategy.class';
    const NEW_ACL_PROVIDER_CLASS = 'Oro\Bundle\SecurityProBundle\Acl\Dbal\MutableAclProvider';
    ...
    const NEW_USER_DELETE_HANDLER_SERVICE_CLASS = 'Oro\Bundle\SecurityProBundle\Form\Handler\UserDeleteHandler';
    const SHARE_PROVIDER_SERVICE = 'oro_securitypro.provider.share_provider';
