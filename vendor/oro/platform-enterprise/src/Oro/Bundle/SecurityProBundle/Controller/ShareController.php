...
namespace Oro\Bundle\SecurityProBundle\Controller;
...
class ShareController extends Controller
{
     ...
     * @return array
     *
     * @Template("OroSecurityProBundle:Share:update.html.twig")
     */
    public function updateAction($entityClass, $entityId)
    {
        ...
        return $this->update($this->get('oro_securitypro.form.model.factory')->getShare(), $entity, $formAction);
    }
     ...
     * @return array
     *
     * @Template("OroSecurityProBundle:Share:share_with.html.twig")
     */
    public function dialogAction($entityClass)
    {
        $supportedGridsInfo = $this->get('oro_securitypro.provider.share_grid_provider')
    ...
    public function datagridAction($entityClass)
    {
        return [
            ...
            'renderParams' => [],
            'multiselect' => true,
            'gridName' => $this->get('oro_securitypro.provider.share_grid_provider')->getGridName($entityClass),
        ];
    }
    ...
    protected function update(Share $model, $entity, $formAction)
    {
        ...
        if ($this->get('oro_securitypro.form.handler.share')->process($model, $entity)) {
            $responseData['saved'] = true;
        }
        $responseData['form'] = $this->get('oro_securitypro.form.share')->createView();
