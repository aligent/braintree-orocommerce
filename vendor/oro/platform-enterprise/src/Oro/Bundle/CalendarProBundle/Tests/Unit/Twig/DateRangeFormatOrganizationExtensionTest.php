...
namespace Oro\Bundle\CalendarProBundle\Tests\Unit\Twig;

use Oro\Bundle\CalendarProBundle\Twig\DateRangeFormatOrganizationExtension;
...
class DateRangeFormatOrganizationExtensionTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->helper = $this->getMockBuilder('Oro\Bundle\LocaleProBundle\Helper\OrganizationConfigHelper')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $this->assertEquals('oro_calendarpro_daterange_format_organization', $this->extension->getName());
    }
}
