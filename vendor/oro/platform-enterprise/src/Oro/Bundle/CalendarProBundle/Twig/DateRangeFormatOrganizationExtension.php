...
class DateRangeFormatOrganizationExtension extends DateFormatExtension
{
    ...
    {
        return 'oro_calendarpro_daterange_format_organization';
    }
}
