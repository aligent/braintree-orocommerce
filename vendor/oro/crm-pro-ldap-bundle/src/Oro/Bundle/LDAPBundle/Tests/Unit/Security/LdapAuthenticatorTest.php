...
class LdapAuthenticatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function mockChannel($id)
    {
        ...
        $channel->expects($this->any())
            ->method('getTransport')
            ->will($this->returnValue($this->createMock('Oro\Bundle\IntegrationBundle\Entity\Transport')));
    ...
    public function setUp()
    {
        ...
        $this->transport = $this->createMock('Oro\Bundle\LDAPBundle\Provider\Transport\LdapTransportInterface');
