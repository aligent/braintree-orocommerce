...
namespace Oro\Bundle\LDAPBundle\Tests\Selenium;
...
use Oro\Bundle\LDAPBundle\Tests\Selenium\Pages\LdapIntegration;
...
class LdapIntegrationTest extends Selenium2TestCase
{
    ...
    public function testCreateLdapIntegration()
    {
        ...
        $login->openLdapIntegration('Oro\Bundle\LDAPBundle')
