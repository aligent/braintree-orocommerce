...
namespace Oro\Bundle\LDAPBundle\Tests\Functional\EventListener;
...
class ImportValidationSubscriberTest extends WebTestCase
{
    ...
    {
        $this->initClient();
        $this->userImportStrategy = $this->getMockBuilder('Oro\Bundle\LDAPBundle\ImportExport\UserImportStrategy')
